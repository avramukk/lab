...
# result.
eval_gettext () {
  /nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/gettext "$1" | (export PATH `/nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/envsubst --variables "$1"`; /nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/envsubst "$1")
}
...
eval_ngettext () {
  /nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/ngettext "$1" "$2" "$3" | (export PATH `/nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/envsubst --variables "$1 $2"`; /nix/store/hlapgwfjgb7fffdina5qk0si7n7px20z-gettext-0.21.1/bin/envsubst "$1 $2")
}
